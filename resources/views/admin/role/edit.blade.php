    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="box-danger">
            <div class="box-header with-border">
                <h3 class="box-title">Editar Rol:&nbsp;&nbsp;&nbsp;&nbsp;  {{ $role->rol }}</h3>
            </div>
            @if (count($errors)>0)
                ...
                <div class="box-body">
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="rol" class="form-control" value="{{ $role->rol }}">
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                        <div class="form-group">
                            <label for="descripcion">Descripcion</label>
                            <input type="text" name="descripcion" class="form-control" value="{{ $role->descripcion }}">
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
