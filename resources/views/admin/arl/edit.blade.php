    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="box-danger">
            <div class="box-header with-border">
                <h3 class="box-title">Editar Arl:&nbsp;&nbsp;&nbsp;&nbsp;  {{ $arl->nombre }}</h3>
            </div>
            @if (count($errors)>0)
            ...
            @endif
            {!!Form::model($arl, ['method'=>'PATCH','route'=>['arl.update', $arl->id]])!!}
            {!!Form::token()!!}
                <div class="box-body">
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                        <div class="form-group">
                            <label for="nombre">Arl</label>
                            <input type="text" name="nombre" class="form-control" value="{{ $arl->nombre }}" placeholder="arl">
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
