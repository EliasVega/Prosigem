...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="box-danger">
            ...
            @endif
            {!!Form::open(array('url'=>'admin/sede', 'method'=>'POST', 'autocomplete'=>'off', 'files' => 'true')) !!}
            {!!Form::token()!!}
                <div class="box-body row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="direccion" value="{{ old('direccion') }}" class="form-control" placeholder="Ingrese La Direccion" required>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="form-group">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <div class="select">
                                <select name="actividadEconomica_id" class="form-control selectpicker" data-live-search="true" id="actividadEconomica_id" required>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <div class="select">
                                <select name="arl_id" class="form-control selectpicker" data-live-search="true" id="arl_id" required>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="telefono" value="{{ old('telefono') }}" class="form-control" placeholder="Ingrese el numero de telefono fijo" required>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label for="celular">Celular Sede</label>
                            <input type="text" name="celular" value="{{ old('celular') }}" class="form-control" placeholder="Ingrese el numero Celular" required>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="gerente" value="{{ old('gerente') }}" class="form-control" placeholder="Nombre del Gerente o Administrador" required>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
